...
## Ссылки
[Дизайн видео] https://drive.google.com/drive/folders/1sk6FlYoE9pWz9egCnu7uinMKR7IG060N?usp=sharing
...
- Поиск по таблице/коллекции

## Цели приложения

- просмотр коллекций NFT;
- просмотр и покупка NFT;
...
2. Откройте проект в Xcode и дождитесь загрузки Kingfisher и ProgressHUD
